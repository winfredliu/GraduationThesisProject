...
def ResNet101(output_stride, BatchNorm, pretrained='https://download.pytorch.org/models/resnet101-5d3b4d8f.pth'):
...
def ResNet50(output_stride, BatchNorm, pretrained='https://download.pytorch.org/models/resnet50-0676ba61.pth'):
    """Constructs a ResNet-101 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
